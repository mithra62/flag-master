...
<div id="all_flags">
	...
	foreach($comment_flags as $option)
	{
	
		$this->table->add_row(
								'<a href="'.$url_base.'view_comment_flag_option'.AMP.'option_id='.$option['option_id'].AMP.'comment_id='.$option['entry_id'].'">'.$option['title'].'</a>'. '<div class="subtext">'.$option['description'].'</div>',
								$option['total_flags'],
