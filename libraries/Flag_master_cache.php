<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 ...
 /**
 * mithra62 - Flag_master_cache
 *
 * @package		mithra62:Flag_master_cache
 * @author		Eric Lamb
 ...
 */
 ...
 /**
 * Flag_master_cache - Cache Library
 *
 * Cache Library
 *
 * @package 	mithra62:Flag_master_cache
 * @author		Eric Lamb
 * @filesource 	./system/expressionengine/third_party/meetup/libraries/Flag_master_cache.php
 */
class Flag_master_cache 
{
	...
	{
		return $this->cache_path ."/". $key . ".m62";	
	}
